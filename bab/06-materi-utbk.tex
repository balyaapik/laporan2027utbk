...
\begin{frame}[shrink=12]{Ketuntasan materi selalu diikuti keputusan}
  ...
  {\fontsize{10.0}{12.5}\selectfont
  \renewcommand{\arraystretch}{0.98}
  \begin{tabularx}{\textwidth}{>{\bfseries\color{StudentBlue}\RaggedRight\arraybackslash}p{0.20\textwidth} >{\RaggedRight\arraybackslash}X >{\RaggedRight\arraybackslash}p{0.31\textwidth}}
    \toprule
