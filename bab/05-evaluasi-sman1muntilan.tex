...
\begin{frame}{Sumber internal evaluasi}
  \kicker{Rujukan Bab 5 -- Bagian 1}
  {\color{StudentBlue}\bfseries\fontsize{14.5}{17.5}\selectfont 1. LPJ Pembimbingan UTBK 2026}\par
  \vspace{0.05cm}
  {\fontsize{10.8}{13.2}\selectfont Dokumen internal StudentPro. Penyusun: Balya Rochmadi.}\par
  {\color{StudentGray}\fontsize{9.8}{12}\selectfont Sumber bentuk kegiatan, layanan konsultasi, monitoring, dan dasar evaluasi program.}\par
  \vspace{0.28cm}
  {\color{StudentBlue}\bfseries\fontsize{14.5}{17.5}\selectfont 2. Rekap hasil seleksi siswa tahun 2026}\par
  \vspace{0.05cm}
  {\fontsize{10.8}{13.2}\selectfont Rekap internal penerimaan SNBT dan UM UGM yang tersedia saat penyusunan.}\par
  {\color{StudentGray}\fontsize{9.8}{12}\selectfont Nama siswa tidak ditampilkan dalam slide publik; validasi akhir dilakukan terhadap daftar peserta unik.}\par
\end{frame}

\begin{frame}{Sumber data dan catatan status}
  \kicker{Rujukan Bab 5 -- Bagian 2}
  {\color{StudentBlue}\bfseries\fontsize{14.5}{17.5}\selectfont 3. Rekap aktivitas StudentPro}\par
  \vspace{0.05cm}
  {\fontsize{10.8}{13.2}\selectfont Materi, latihan, tryout, scoring, ketuntasan, konsultasi, dan tindak lanjut yang tersedia.}\par
  {\color{StudentGray}\fontsize{9.8}{12}\selectfont Digunakan sebagai sumber data proses; kelengkapan historis belum selalu seragam.}\par
  \vspace{0.28cm}
  {\color{StudentBlue}\bfseries\fontsize{14.5}{17.5}\selectfont 4. Catatan ranking UTBK 2026}\par
  \vspace{0.05cm}
  {\fontsize{10.8}{13.2}\selectfont Posisi 53 berasal dari catatan internal dan memerlukan metadata sumber sebelum dipublikasikan sebagai klaim sekolah.}\par
  \vfill
  \begin{beamercolorbox}[rounded=true,sep=0.16cm,wd=\textwidth]{block body}
    \centering\bfseries Bab 6 selanjutnya memetakan materi UTBK sebagai dasar kurikulum pembimbingan.
  \end{beamercolorbox}
\end{frame}
