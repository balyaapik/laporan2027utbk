...
% Slide 13 --------------------------------------------------------------------
\begin{frame}[shrink=4]{Contoh LBI: jawaban harus bertumpu pada bukti bacaan}
...
% Slide 15 --------------------------------------------------------------------
\begin{frame}[shrink=1]{Penalaran Matematika menghubungkan masalah nyata dan model}
